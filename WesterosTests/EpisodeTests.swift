...
class EpisodeTests: XCTestCase {
    ...
    override func setUp() {
        ...
        cloneEpisode1 = Episode(title: title1, screeningDate: screeningDate1!, synopsis: synopsis1, directedBy: sampleDirectedBy, writtenBy: sampleWrittenBy, season: season1)
